...
const QMetaObjectExtraData GridWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GridWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_GridWindow,
      qt_meta_data_GridWindow, &staticMetaObjectExtraData }
};
